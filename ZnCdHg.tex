...
\subtitle{Zinek, kadmium, rtuť a copernicium}
...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Nejstabilnějším izotopem je \ce{^{285}Cn} s poločasem rozpadu 29~s.
		\end{itemize}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Je toxické.
		\item Má osm stabilních izotopů a 38 radioizotopů.
	\end{itemize}
	\begin{center}
	\begin{tabular}{|l|r@{,}l|l|}
		...
		111 & 12 & 80 & \\\hline
		112 & 24 & 11 & \\\hline
		113 & 12 & 23 & 7,7 $\times$ 10$^{15}$ let\\\hline
		114 & 28 & 75 & \\\hline
		116 & 7 & 51 & 3,1 $\times$ 10$^{19}$ let\\\hline
	\end{tabular}
	\end{center}
	\begin{itemize}
...
\frame{
	\frametitle{}
	\begin{itemize}
		\item U rtuti byla poprvé pozorována supravodivost. Heike Kamerlingh-Onnes prováděl v roce 1911 měření odporu rtuti za nízkých teplot.
	...
	\begin{columns}
		...
		\begin{figure}
			\adjincludegraphics[width=\textwidth]{img/mercury-temp-res-1.png}
		\end{figure}
		\end{column}
		\begin{column}{.4\textwidth}
		\begin{figure}
			\adjincludegraphics[width=\textwidth]{img/Kamerlingh_portret.jpg}
		\end{figure}
	\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Sphalerite.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.6\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Sphalerite_polyhedra.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Wurtzite-245570.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.6\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Wurtzite_polyhedra.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Světová roční produkce kadmia se blíží k 20 000 tunám.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/2005cadmium.png}
		\caption*{Světová produkce kadmia v roce 2005}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Dříve se využíval jako žlutý pigment, kadmiová žluť.\footnote[frame]{Dnes se kvůli toxicitě nepoužívá.}
	\end{itemize}

	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Greenockite-259580.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Greenockite-Hemimorphite.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Pouring_liquid_mercury_bionerd.jpg}
		\adjincludegraphics[height=.4\textheight]{img/Mercury2.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Cinnabar.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Cinnabar-3d6c.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Chinese_carved_cinnabar_lacquerware.jpg}
		\caption*{Čínské vázy barvené cinabaritem}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Calomel-154907.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Calomel-222734.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				...
				\caption*{Střecha z pozinkovaného plechu}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.6\textheight]{img/Brassdoor.jpg}
				\caption*{Mosazné dveře                                      }
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.65\textheight]{img/DiphenylzincCarbonylAddition.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Slitina s rtutí se využívá pro konstrukci MCT detektorů pro infračervenou spektroskopii.
		\item MCT -- Mercury-Cadmium-Tellur
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Polarografie je elektrochemická metoda, kterou objevil Jaroslav Heyerovský. Za tento objev dostal v roce 1959 Nobelovu cenu za chemii.\footnote[frame]{\href{https://www.nobelprize.org/prizes/chemistry/1959/summary/}{The Nobel Prize in Chemistry 1959}}
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Heyrovsky_Jaroslav.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.6\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.35\textheight]{img/Polarogramm.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Heyerovského polarograf}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\item Stopy rtuti se používají v zářivkách.\footnote[frame]{\href{https://www.youtube.com/watch?v=NY3Q_Lt7XYw}{Video - Je rtuť opravdu tolik nebezpečná?}}
	\end{itemize}
	\end{column}
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[width=.85\textwidth]{img/Barometer_mercury.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.45\textheight]{img/Mercury_iodide.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Chlorid rtuťnatý je velmi málo rozpustný ve vodě (0,006~g/100~cm$^3$), ale dobře se rozpouští v roztocích alkalických iodidů. Dochází totiž ke vzniku komplexních sloučenin:
...
\frame{
	...
	\begin{column}{.3\textwidth}
		\begin{figure}
			\adjincludegraphics[width=1.2\textwidth]{img/Decamethyldizincocene_xtal.png}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Zinc_oxide.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Využívá se v dermatologii jako součást kalamínových mastí.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.8\textheight]{img/ZnCO3.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Cd2Cl6.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Dimethyl-mercury-3D-vdW.png}
	\end{figure}
	\vfill
}
